										...
										<div className="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
											<table className="min-w-full divide-y divide-solid divide-gray-200">
												...
												<tr className="hover:bg-gray-50">
													...
													<td className="px-3 py-4 text-center whitespace-nowrap text-sm text-gray-500"><input type="checkbox"
									...
									<div className="sm:flex-1 sm:flex sm:items-center sm:justify-between">
										...
										<div>
											<nav className="relative z-0 inline-flex rounded-md shadow-sm -space-x-px" aria-label="Pagination">
												...
												<span
													className="relative inline-flex items-center px-4 py-2 border border-solid border-gray-300 bg-white text-sm font-medium text-gray-700">
                        ...
                      </span>
												<a
													href="#"
