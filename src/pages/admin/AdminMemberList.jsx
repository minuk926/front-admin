...
import { CogIcon, FolderIcon, HomeIcon, MenuIcon, UsersIcon, XIcon } from '@heroicons/react/outline';
import { CheckIcon, ChevronRightIcon, TrashIcon, ChevronLeftIcon, PencilIcon, SearchIcon } from '@heroicons/react/solid';
              ...
              <div className="flex flex-col  bg-gray-100">
                ...
                <div className="pt-3 items-center justify-between  border-t border-gray-200">
                  <div className="sm:flex-1 sm:flex sm:items-center sm:justify-between">
                    <div>
                      <p className="text-sm text-gray-700 mb-3 mt-3 sm:mb-0 sm:mt-0">전체 회원수 : 10명</p>
                    </div>
                    <div>
